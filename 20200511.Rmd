...
#用這樣寫是有風險的，因為我們不能確定學號的107或108一定在學屆的位子上，因為搞不好有任末三碼是107或108電腦還是會將它判定為TRUE
...
也可以寫
```{r}
strip5 <- "[0-9][0-9][0-9]號"
str_extract(addresses, strip5)
```
